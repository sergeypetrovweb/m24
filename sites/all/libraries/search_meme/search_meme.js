...
(function ($) {
    $.fn.extend({
        searchMeme: function (options) {
            ...
            var settings = $.extend({ animationSpeed: 500, defaultText: 'Search...', button: 'orange', buttonPlacement: 'left', onSearch: null, searchComplete: false, animate: true }, options);
